...
import edu.javaproject.domain.Adult;
import edu.javaproject.domain.Child;
import edu.javaproject.domain.StudentOrder;
import edu.javaproject.domain.StudentOrderStatus;
...
public class StudentOrderDaoImpl implements StudentOrderDao {
    ...
    private static final String SELECT_ORDERS = "select so.*,  ro.r_office_area_id, ro.r_office_name, po_h.p_office_area_id as h_p_office_area_id, po_h.p_office_name as h_p_office_name, \n" +
    ...
    private static final String SELECT_ORDERS_FULL = "select so.*, ro.r_office_area_id, ro.r_office_name, po_h.p_office_area_id as h_p_office_area_id, po_h.p_office_name as h_p_office_name,  \n" +
            "po_w.p_office_area_id as w_p_office_area_id, po_w.p_office_name as w_p_office_name,\n" +
...
//            Муж
    ...
    private void setParamsForAdult(PreparedStatement stmt, int start, Adult adult) throws SQLException {
        ...
        stmt.setString(start + 5, adult.getPassportSNumber());
...
//       return getStudentOrdersTwoSelect();
    ...
    private Adult fillAdult(ResultSet rs, String prefix) throws SQLException {
        ...
        adult.setPassportSNumber(rs.getString(prefix + "passport_number"));
    ...
    private void findChildren(Connection con, List<StudentOrder> result) throws SQLException {
        ...
        Map<Long, StudentOrder> maps = new HashMap<>();
        for (StudentOrder studentOrder : result) {
            if (maps.put(studentOrder.getStudentOrderId(), studentOrder) != null) {
